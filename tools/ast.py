...
def define_ast(output_dir: str, file: str, types: list[str]) -> None:
    ...
    with open(path, "w") as f:
        ...
        f.write("\tAccept(visitor " + cls + "Visitor) any\n")
        f.write("}\n\n")
        ...
        for type_def in types:
            ...
            f.write(f"\tVisit{class_name}{cls}({cls.lower()} *{class_name}) any\n")
        f.write("}\n\n")
        ...
        for type_def in types:
            ...
            # Accept method
            f.write(f"func (node *{class_name}) Accept(visitor {cls}Visitor) any {{\n")
